                ...
                <div class="card card-invoice">
                    <div class="card-body">
                        <div class="invoice-header">
                            <div class="invoice-title">فاتورة التحصيل تم طباعة بواسطة {{Auth::user()->name}} </div>
                            <div class="billed-from">
                                <h6>ahmed alammar</h6>
                                <p>saudi arabic alzulfi <br>
                                    Tel No: 0538381925<br>
                                    Email: ksa0.net@gmail.com</p>
                            </div><!-- billed-from -->
                        </div><!-- invoice-header -->
                        <div class="row mg-t-20">
                            <div class="col-md">
                                <label class="tx-gray-600">By {{Auth::user()->name}}</label>
                                <div class="billed-to">
                                    <h6>ahmed alammar</h6>
                                    <p>saudi arabic alzulfi<br>
                                        Tel No: 0538381925<br>
